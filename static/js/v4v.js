...
var v4v = (function() {
    function V4V(){
        ...
        function plotToPath(_ratio, _points) {
            ...
            //console.log("Section: "+_section.toString);
            var cData = _path[Number(_section)] != undefined ? _path[Number(_section)] : _path[0];
            var nData = _path[Number(_section + 1)] != undefined ? _path[Number(_section + 1)] : _path[0];
